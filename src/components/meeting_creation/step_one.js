        ...
        <div className="row no-gutters justify-content-center">
          <div className="col-md-7">
            <div className="shadow-card">
              <h3 className="bold">
                🤝 Hello there! What is your meeting about?
              </h3>
              <p className="label field-spacing">
                Meeting Title<span className="asterisk bold"> *</span>
              </p>
              <input
              ...
              <textarea
                ...
                type="text"
                placeholder="1. Get the ducks in a row&#x0a;2. Boil the ocean&#x0a;..."
                rows="6"
                value={description}
